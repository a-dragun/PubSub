...
| UX-04    | The system must provide responsive interface optimized for using basic functions and playing quiz on mobile devices.               | User Experience        | DONE   |
| UX-05    | The system shall display clear and informative error messages to users.                          | User Experience        | DONE   |
